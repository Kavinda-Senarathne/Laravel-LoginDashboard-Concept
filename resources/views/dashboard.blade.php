      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  <!-- Morris chart - StudentsEnrolled -->
                  <div class="chart tab-pane active" id="revenue-chart"
                       style="position: relative; height: 300px;">
                      <canvas id="revenue-chart-canvas" height="300" style="height: 300px;"></canvas>                         
                   </div>
                  <div class="chart tab-pane" id="StudentsEnrolled-chart" style="position: relative; height: 300px;">
                    <canvas id="StudentsEnrolled-chart-canvas" height="300" style="height: 300px;"></canvas>                         
                  </div>  
                </div>
              </div><!-- /.card-body -->
            </div>
          ...
          <section class="col-lg-5 connectedSortable">
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  ...
                  <div class="col-4 text-center">
                    ...
                    <div class="text-white">StudentsEnrolled</div>
                  </div>
                  <!-- ./col -->
                </div>
                <!-- /.row -->
            ...
            <!-- solid StudentsEnrolled graph -->
            <div class="card bg-gradient-info">
              <div class="card-header border-0">
                <h3 class="card-title">
                  <i class="fas fa-th mr-1"></i>
                  Students Enrolled Progress Graph
                </h3>
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  ...
                  <div class="col-4 text-center">
                    ...
                    <div class="text-white">Institute</div>
                  </div>
                  <!-- ./col -->
                </div>
                <!-- /.row -->
